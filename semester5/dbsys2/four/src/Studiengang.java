...
public class Studiengang {
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			...
			for(int i = 0; i < lVorlesungs.length; i++) {
				lVorlesungs[i].setStudiengangs(null);
			}
			return delete();
		}
		catch(Exception e) {
	...
	public final VorlesungSetCollection vorlesung = new VorlesungSetCollection(this, _ormAdapter, ORMConstants.KEY_STUDIENGANG_VORLESUNG, ORMConstants.KEY_VORLESUNG_STUDIENGANGS, ORMConstants.KEY_MUL_ONE_TO_MANY);
