CREATE TABLE Vorlesung (ID number(10) GENERATED AS IDENTITY, StudiengangKuerzel varchar2(255) NOT NULL, Sws number(10) NOT NULL, Ects number(10) NOT NULL, Name varchar2(255), PRIMARY KEY (ID));
